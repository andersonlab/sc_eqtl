...
condition="healthy"
covariates="age,sex,Keras:predicted_celltype_probability"
expression_pca=True
...
# NOTE: REMOVE THIS WHEN NOT TESTING!!!
...
adata = adata[~adata.obs[covs_use].isna().any(axis=1)]
...
for c in cats:
    ...
    geno_pcs.rename(columns={"index": genotype_id}, inplace=True)
